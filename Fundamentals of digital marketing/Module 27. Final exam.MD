...
## :star: 36. When trying to increase the product sales on your website, one way to achieve this is to_________?

:x: A. send multiple follow up emails once a purchase has been made\
:x: B. show them remarketing ads with a variety of products\
:heavy_check_mark: **C. show them remarketing ads with a variety of products**\
:x: D. include a pop up on your website that they have to action before continuing

## :star: 37. If a user abandons their shopping cart without making a purchase, one way to bring them back to complete the purchase is?

:x: A. SEM advertising\
:x: B. Social advertising\
:heavy_check_mark: **C. Retargeting**\
:x: D. Email campaigns

# :eight_pointed_black_star: Take a business global

## :star: 38. When looking to expand your business internationally on social media, what should you do first?

:x: A. Treat all social media channels the same\
:x: B. Use popular phrases and memes for that area\
:heavy_check_mark: **C. Analyse platforms popular in that area**\
:x: D. Not advertise at all, as other countries don't like social advertising

## :star: 39. Fill the blanks: When advertising internationally, you should make your business ______ to the new market, consider the ___________ and any possible ___________ implications.

:heavy_check_mark: **A. accessible | supply chain | legal**\
:x: B. affordable | supply chain | language\
:x: C. exciting | customers needs | currency\
:x: D. affordable | customer needs | legal

## :star: 40. If you are looking to expand your company's presence online internationally, which of the following should you consider with regards to your online content?

:x: A. Translated by an automated tool only\
:heavy_check_mark: **B. Translated but also locally adapted for the audience**\
:x: C. Translated into the native language\
:x: D. Left the same, and not translated